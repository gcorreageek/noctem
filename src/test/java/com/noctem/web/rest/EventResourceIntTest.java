...
public class EventResourceIntTest {
    ...
    private static final TypeEvent DEFAULT_TYPE_EVENT = TypeEvent.LIST;
    private static final TypeEvent UPDATED_TYPE_EVENT = TypeEvent.PARTY;
    ...
    public static Event createEntity(EntityManager em) {
        ...
        event.setTypeEvent(DEFAULT_TYPE_EVENT);
        event.setDate(DEFAULT_DATE);
        event.setSubject(DEFAULT_SUBJECT);
    ...
    public void createEvent() throws Exception {
        ...
        assertThat(testEvent.getTypeEvent()).isEqualTo(DEFAULT_TYPE_EVENT);
    ...
    @Test
    @Transactional
    public void checkTypeEventIsRequired() throws Exception {
        int databaseSizeBeforeTest = eventRepository.findAll().size();
        // set the field null
    ...
    public void getAllEvents() throws Exception {
        ...
        restEventMockMvc.perform(get("/api/events?sort=id,desc"))
                ...
                .andExpect(jsonPath("$.[*].typeEvent").value(hasItem(DEFAULT_TYPE_EVENT.toString())))
    ...
    public void getEvent() throws Exception {
        ...
        restEventMockMvc.perform(get("/api/events/{id}", event.getId()))
            ...
            .andExpect(jsonPath("$.typeEvent").value(DEFAULT_TYPE_EVENT.toString()))
    ...
    public void updateEvent() throws Exception {
        ...
        updatedEvent.setTypeEvent(UPDATED_TYPE_EVENT);
        updatedEvent.setDate(UPDATED_DATE);
        updatedEvent.setSubject(UPDATED_SUBJECT);
        updatedEvent.setMessage(UPDATED_MESSAGE);
        ...
        assertThat(testEvent.getTypeEvent()).isEqualTo(UPDATED_TYPE_EVENT);
